...
type Material = {
    ...
    { 
        ...
        details: `# שיעור חומש ורש"י: פרשת וירא - ניסיון עקדת יצחק\n\n### 🎯 מטרות השיעור\n- התלמיד יגדיר ויסביר את המושג "ניסיון" ואמונת האבות העצומה.\n- הבנה שלמילים "קח נא את בנך" יש משמעות עמוקה של חיבה ורצון הבורא.\n- ניתוח פירוש רש"י הקדוש על כל היבטיו הפשטניים והמדרשיים.\n\n### 🕰️ שלבי השיעור המרכזיים\n1. **עוררות הרגש והלב (15 דקות)**: שיחה על גודל אמונתו של אברהם אבינו ע"ה.\n2. **הוראה והקראה (30 דקות)**: קריאת הפסוקים ובאור רש"י מילה במילה בעיון.\n3. **עבודה שיתופית בחברותא (30 דקות)**: כתיבת סדר הניסיונות ודיון על מסירות הנפש.\n4. **סיום ושינון (15 דקות)**: שנון פסוקי העקדה בעל פה וסיכום פדגוגי מרומם.`, 
        status: 'organized',
        understandings: ['אמונת חכמים ומסירות הנפש של אבות האומה', 'פענוח פירוש רש"י על פי סגנון לשונו הקצר והמדויק'],
        sections: ['שיחת פתיחה מעוררת', 'הקראת הפסוקים וביאורם', 'לימוד חברותא משותף', 'חזרה וקבלת קבלות טובות'],
        order: 'חקירה מוסרית של הניסיון, הבנת הפשט עם פירושי רש"י, יישום מעשי של מידות טובות',
        attachments: [
            { id: '2a', name: 'דפי צביעה ושינון - פרשת וירא.pdf', type: 'pdf', url: 'https://example.com/vayeira_study.pdf' }
        ]
    },
    { 
        id: '3', 
        title: 'דף עבודה ושעשועי משנה: מסכת אבות פרק א׳', 
        type: 'worksheet', 
        topic: 'משנה', 
        subtopic: 'מסכת אבות', 
        tags: ['משנה', 'פרקי אבות', 'מוסר ומידות', 'שנון בעל פה'], 
        difficulty: 'easy',
        gradeLevel: 'כיתה ג׳',
        estimatedTime: '45 דקות',
        ...
        status: 'draft',
        understandings: ['זיהוי מחברי המשנה ותקופת חייהם בקודש', 'הבנת המשמעות המוסרית של מידות טובות ודרך ארץ שקדמה לתורה'],
        sections: ['הקדמה ושנון קבוצתי', 'עבודה עצמית חננית', 'סקירת הרבי וחלוקת פרסים'],
        attachments: [
            { id: '3a', name: 'משנה משעשעת - להדפסה ביתית.pdf', type: 'pdf', url: 'https://example.com/mishna_game.pdf' }
        ]
    },
    { 
        id: '4', 
